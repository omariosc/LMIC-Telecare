...
export const dummyCases: MedicalCase[] = [
  {
    ...
    description: "45-year-old male presenting with chest pain and elevated troponins. ECG shows ST elevation in leads II, III, aVF. Patient has history of diabetes and hypertension. Blood pressure 90/60, HR 110. Considering STEMI but limited catheterization facilities available.",
    ...
    medicalHistory: "Type 2 diabetes mellitus (10 years), hypertension (5 years), father died of MI at age 50",
    currentMedications: ["Metformin 1000mg BD", "Amlodipine 10mg OD", "Aspirin 75mg OD"],
    allergies: ["NKDA"],
    vitalSigns: {
      temperature: 36.8,
    ...
    differentialDiagnosis: ["STEMI", "NSTEMI", "Aortic dissection", "Pneumothorax"],
    testResults: [
      {
        id: "test_001",
        testType: "Blood Test",
        ...
        unit: "ng/mL",
        status: "critical",
        interpretation: "Significantly elevated indicating myocardial infarction",
  ...
  
  {
    ...
    description: "3-year-old child with acute respiratory symptoms. Started with fever and cough 2 days ago, now showing increased work of breathing. Temp 38.5°C, RR 45, O2 sat 88% on room air. Bilateral wheeze on auscultation. Mother reports previous episodes of similar symptoms.",
    summary: "Acute asthma exacerbation in 3-year-old requiring bronchodilator therapy",
    ...
    medicalHistory: "Previous episodes of wheeze, no formal asthma diagnosis, born at term",
    ...
    differentialDiagnosis: ["Asthma exacerbation", "Bronchiolitis", "Pneumonia"],
    ...
    resolutionSummary: "Child responded well to nebulized salbutamol and prednisolone. Discharged home with inhaler and spacer device.",
    treatmentPlan: "Salbutamol inhaler 2 puffs QID via spacer, Prednisolone 15mg OD for 3 days, follow-up in 48 hours",
    followUpRequired: true,
    followUpInstructions: "Return if breathing difficulties worsen or fever persists beyond 48 hours",
  ...
  
  {
    ...
    description: "28-year-old female presenting with 6-hour history of severe right iliac fossa pain. Started periumbilically and migrated to RIF. Associated with nausea and vomiting. No fever initially, now temp 37.8°C. Positive McBurney's point tenderness.",
    ...
    resolutionSummary: "Patient underwent laparoscopic appendectomy. Appendix was inflamed but not perforated. Good post-operative recovery.",
    treatmentPlan: "Laparoscopic appendectomy performed successfully, post-op antibiotics, early mobilization",
    followUpRequired: true,
...
export const dummyResponses: CaseResponse[] = [
  {
    ...
    treatmentRecommendation: "Thrombolysis, dual antiplatelet therapy, high-intensity statin",
    urgencyAssessment: "critical",
    additionalTestsNeeded: ["Serial ECGs", "Repeat troponins in 12h", "Echo if available"],
    language: "en",
    createdBy: "uk_001",
    likeCount: 5,
    thanksCount: 3,
  ...
  
  {
    ...
    treatmentRecommendation: "Bronchodilators, oral prednisolone, oxygen therapy",
    urgencyAssessment: "high",
    additionalTestsNeeded: ["Chest X-ray if available", "Peak flow if child cooperative"],
    language: "en",
    createdBy: "uk_002",
    likeCount: 8,
    thanksCount: 5,
  ...
  
  {
    id: "response_004",
    caseId: "case_003",
    content: "Classic presentation of acute appendicitis. The migration of pain from periumbilical to right iliac fossa is pathognomonic. Given the clinical picture and elevated WCC, surgical intervention is indicated. In your setting, I would recommend laparoscopic approach if expertise available, otherwise open appendectomy. Pre-operative antibiotics (cefuroxime + metronidazole) should be given.",
    responseType: "consultation",
    isPrivate: false,
    isHelpful: true,
    isPrimaryConsultation: true,
    ...
    treatmentRecommendation: "Appendectomy (laparoscopic preferred), prophylactic antibiotics",
    urgencyAssessment: "high",
