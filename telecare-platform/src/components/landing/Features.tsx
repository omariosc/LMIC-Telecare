...
const FEATURE_LIST = [
  {
    ...
    description: "24/7 instant access to UK specialists for critical medical emergencies in Gaza",
    icon: "🚨",
    highlight: "emergency",
  },
  {
    ...
    description: "Encrypted video and chat communication between Gaza clinicians and UK experts",
    icon: "📹",
    highlight: "secure",
  },
  {
    ...
    description: "Intelligent specialist matching based on medical expertise and availability",
    icon: "🎯",
  ...
  },
  {
    ...
    description: "Secure patient data documentation and medical record management",
    icon: "📋",
  ...
  },
  {
    ...
    description: "Works offline with limited internet - designed for Gaza's connectivity challenges",
    icon: "📱",
    highlight: "offline",
  },
  {
    ...
    description: "Full multilingual interface with medical translation capabilities",
    icon: "🌍",
...
export const Features: React.FC = () => {
  return (
    ...
    >
      ...
      <div data-testid="features-container" className="container-responsive relative z-10">
        <div className="text-center max-w-5xl mx-auto mb-16 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-gray-700 leading-relaxed">
            Humanitarian medical technology designed specifically for Gaza's healthcare crisis
          </p>
        </div>
        ...
        <div className="text-center animate-slide-up">
          <div className="inline-flex items-center gap-3 px-8 py-4 bg-white/90 backdrop-blur-sm rounded-2xl border border-medical-red-200 shadow-lg hover-lift">
            ...
            <span className="text-medical-red-700 font-semibold text-lg">
              🚨 Emergency consultations available 24/7 with HIPAA-compliant security
            </span>
          </div>
        </div>
