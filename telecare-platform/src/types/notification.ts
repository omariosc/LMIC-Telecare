...
export interface AchievementRequirement {
  type: 'case_count' | 'response_count' | 'satisfaction_rating' | 'response_time' | 'consecutive_days' | 'specialty_coverage' | 'volunteer_hours';
...
export interface Leaderboard {
  ...
  name: string;
  description: string;
  type: 'points' | 'cases_handled' | 'response_time' | 'satisfaction' | 'volunteer_hours';
