...
export interface Translation extends Metadata {
  ...
  contentType: 'text' | 'medical_term' | 'instruction' | 'diagnosis' | 'treatment';
  ...
  sourceResourceType?: 'case' | 'response' | 'ui_text' | 'notification' | 'document';
  sourceResourceId?: ID;
  usageCount: number;
...
export interface TranslationIssue {
  ...
  resolutionAction?: 'updated_translation' | 'marked_correct' | 'added_alternative' | 'removed_translation';
...
export interface TerminologyEntry {
  ...
  // Classification
  category: 'anatomy' | 'symptom' | 'disease' | 'treatment' | 'medication' | 'procedure' | 'general';
  specialty?: string;
...
export interface LocalizedContent {
  ...
  contentType: 'ui_text' | 'email_template' | 'notification' | 'help_text' | 'error_message';
